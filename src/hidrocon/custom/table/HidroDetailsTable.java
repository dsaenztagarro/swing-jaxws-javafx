 ...
 * @author david
 */
public class HidroDetailsTable extends JTable {

	public HidroDetailsTable() {
		super();
		initProperties();
	}
	...
	private void initProperties() {
		...
		header.setPreferredSize(new Dimension(this.getColumnModel().getTotalColumnWidth(), Constant.TABLE_DETAIL_ROW_HEIGHT));
        //header.setDefaultRenderer(new HidroHeaderRenderTable());
		...
		setRowHeight(Constant.TABLE_DETAIL_ROW_HEIGHT);
