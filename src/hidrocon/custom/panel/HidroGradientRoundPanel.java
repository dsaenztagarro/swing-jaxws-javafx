 ...
 */
public class HidroGradientRoundPanel extends JPanel{
  ...
  private int arcHeight = 5;
	...
	public HidroGradientRoundPanel() {
		super();
		initProperties();
	}
  ...
  public HidroGradientRoundPanel( int direction )
  {
    super();
    setOpaque( false );
  ...
  public HidroGradientRoundPanel( LayoutManager layoutManager )
  {
    super( layoutManager );
    setOpaque( false );
