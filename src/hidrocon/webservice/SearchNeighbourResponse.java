 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://webservice.hidrocon/}neighbour" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SearchNeighbourResponse {
    ...
    protected List<Neighbour> _return;
     ...
     * 
     */
    public List<Neighbour> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Neighbour>();
        }
        return this._return;
    }
