...
public class BuildingMainPanelView extends hidrocon.custom.panel.HidroMainPanel {
    ...
    public void setBuildingList(List list) {
        //buildingList.clear();
        if (list!=null) {
            buildingList = org.jdesktop.observablecollections.ObservableCollections.observableList(list);
        }
    }
    ...
    private void initComponents() {
        ...
        buildingList = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<Building>());
