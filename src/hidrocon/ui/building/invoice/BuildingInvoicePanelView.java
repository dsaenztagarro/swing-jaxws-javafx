 ...
 */
public class BuildingInvoicePanelView extends javax.swing.JPanel {

    HidroEditButton editButton;
    HidroSaveButton saveButton;
    HidroExitButton exitButton;
    
    private List<NeighbourMeter> neighbourMeterList;
    
    /** Creates new form BuildingInvoicePanelView */
    public BuildingInvoicePanelView() {
        initComponents();
        initTopPanel();
        customizeComponents();
    }
