...
/*
 * NeighbourDetailsPanelView.java
 *
 ...
 */
public class NeighbourDetailsPanelView extends javax.swing.JPanel {

    HidroEditButton editButton;
    HidroSaveButton saveButton;
    HidroExitButton exitButton;
    
    /** Creates new form NeighbourDetailsPanelView */
    public NeighbourDetailsPanelView() {
        initComponents();
        initTopPanel();
        customizeComponents();
    }
    ...
    protected void customizeComponents() {
        ...
        //Sections:
        //Details 1 panel:
        detailsSection.setImageIcon(new HidroContactLegend());                        
    ...
    protected void initTopPanel() {
        ...
        editButton.setToolTipText(resourceMap.getString("neighbour.details.toolbar.editbutton.tooltip"));
    ...
    public void readData(Neighbour neighbour) {
    ...
    private void initComponents() {
        ...
        inicialLabel = new hidrocon.custom.label.HidroLabel();
        modelLabel = new hidrocon.custom.label.HidroLabel();
        colegiadoLabel = new hidrocon.custom.label.HidroLabel();
        inicialField = new hidrocon.custom.field.HidroTextField();
        colegiadoField = new hidrocon.custom.field.HidroIntegerField();
        ...
        dirField = new hidrocon.custom.field.HidroTextField();
        dirLabel = new hidrocon.custom.label.HidroLabel();
        distritoLabel = new hidrocon.custom.label.HidroLabel();
        ...
        distritoField = new hidrocon.custom.field.HidroTextField();
        datosfincaLabel = new hidrocon.custom.label.HidroLabel();
        edificioField = new hidrocon.custom.field.HidroTextField();
        filler2 = new javax.swing.Box.Filler(new java.awt.Dimension(10, 0), new java.awt.Dimension(10, 0), new java.awt.Dimension(10, 10));
        contafField = new hidrocon.custom.field.HidroTextField();
        contacField = new hidrocon.custom.field.HidroTextField();
        numafvivField = new hidrocon.custom.field.HidroTextField();
        numacvivField = new hidrocon.custom.field.HidroTextField();
        contafLabel = new hidrocon.custom.label.HidroLabel();
        contacLabel = new hidrocon.custom.label.HidroLabel();
        numacvivLabel = new hidrocon.custom.label.HidroLabel();
        numafvivLabel = new hidrocon.custom.label.HidroLabel();
        ...
        numlectanoLabel = new hidrocon.custom.label.HidroLabel();
        numlectanoField = new hidrocon.custom.field.HidroIntegerField();
        ...
        nombaviField = new hidrocon.custom.field.HidroTextField();
        jLabel3 = new hidrocon.custom.label.HidroLabel();
        numaviTextField = new hidrocon.custom.field.HidroTextField();
        diraviField = new hidrocon.custom.field.HidroTextField();
        distaviField = new hidrocon.custom.field.HidroTextField();
        telcontactLabel = new hidrocon.custom.label.HidroLabel();
        telcontactField = new hidrocon.custom.field.HidroTextField();
        telcontact2Field = new hidrocon.custom.field.HidroTextField();
        ...
        hidroPanel1.setPreferredSize(new java.awt.Dimension(560, 61));

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(hidrocon.HidroconApp.class).getContext().getResourceMap(NeighbourDetailsPanelView.class);
        inicialLabel.setText(resourceMap.getString("inicialLabel.text")); // NOI18N
        inicialLabel.setName("inicialLabel"); // NOI18N

        modelLabel.setText(resourceMap.getString("modelLabel.text")); // NOI18N
        modelLabel.setName("modelLabel"); // NOI18N

        colegiadoLabel.setText(resourceMap.getString("colegiadoLabel.text")); // NOI18N
        colegiadoLabel.setName("colegiadoLabel"); // NOI18N

        inicialField.setName("inicialField"); // NOI18N

        colegiadoField.setName("colegiadoField"); // NOI18N
        ...
        hidroPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(hidroPanel1Layout.createSequentialGroup()
                .addComponent(inicialLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(inicialField, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26)
                .addGroup(hidroPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(colegiadoLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(hidroPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(modelField, 0, 0, Short.MAX_VALUE)
                    .addComponent(colegiadoField, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE))
                .addGap(421, 421, 421))
        );
            ...
            .addGroup(hidroPanel1Layout.createSequentialGroup()
                .addGroup(hidroPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(hidroPanel1Layout.createSequentialGroup()
                        .addGroup(hidroPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(colegiadoLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(colegiadoField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(7, 7, 7)
                        .addGroup(hidroPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(modelLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        mainPanel.add(hidroPanel1, gridBagConstraints);
        ...
        detailsPanel.add(dirField, gridBagConstraints);
        ...
        detailsPanel.add(dirLabel, gridBagConstraints);

        distritoLabel.setText(resourceMap.getString("distritoLabel.text")); // NOI18N
        distritoLabel.setName("distritoLabel"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 0, 0, 0);
        detailsPanel.add(distritoLabel, gridBagConstraints);
        ...
        distritoField.setName("distritoField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.ipadx = 93;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 10, 0, 0);
        detailsPanel.add(distritoField, gridBagConstraints);

        datosfincaLabel.setText(resourceMap.getString("datosfincaLabel.text")); // NOI18N
        datosfincaLabel.setName("datosfincaLabel"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 0, 0, 0);
        detailsPanel.add(datosfincaLabel, gridBagConstraints);

        edificioField.setName("edificioField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 10, 0, 0);
        detailsPanel.add(edificioField, gridBagConstraints);
        ...
        contafField.setName("contafField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 10, 0, 0);
        detailsPanel.add(contafField, gridBagConstraints);

        contacField.setName("contacField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 11;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.ipadx = 38;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 10, 0, 0);
        detailsPanel.add(contacField, gridBagConstraints);

        numafvivField.setName("numafvivField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 11;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.ipadx = 38;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 10, 0, 0);
        detailsPanel.add(numafvivField, gridBagConstraints);

        numacvivField.setName("numacvivField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 11;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.ipadx = 38;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 10, 0, 0);
        detailsPanel.add(numacvivField, gridBagConstraints);

        contafLabel.setText(resourceMap.getString("contafLabel.text")); // NOI18N
        contafLabel.setName("contafLabel"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 10;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 0, 0, 0);
        detailsPanel.add(contafLabel, gridBagConstraints);

        contacLabel.setText(resourceMap.getString("contacLabel.text")); // NOI18N
        contacLabel.setName("contacLabel"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 10;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 0, 0, 0);
        detailsPanel.add(contacLabel, gridBagConstraints);

        numacvivLabel.setText(resourceMap.getString("numacvivLabel.text")); // NOI18N
        numacvivLabel.setName("numacvivLabel"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 10;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 0, 0, 0);
        detailsPanel.add(numacvivLabel, gridBagConstraints);

        numafvivLabel.setText(resourceMap.getString("numafvivLabel.text")); // NOI18N
        numafvivLabel.setName("numafvivLabel"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 10;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 0, 0, 0);
        detailsPanel.add(numafvivLabel, gridBagConstraints);
        ...
        numlectanoLabel.setText(resourceMap.getString("numlectanoLabel.text")); // NOI18N
        numlectanoLabel.setName("numlectanoLabel"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.insets = new java.awt.Insets(6, 20, 0, 5);
        detailsPanel.add(numlectanoLabel, gridBagConstraints);

        numlectanoField.setName("numlectanoField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 6;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(3, 0, 0, 0);
        detailsPanel.add(numlectanoField, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        mainPanel.add(contactSection, gridBagConstraints);
        ...
        nombaviField.setName("nombaviField"); // NOI18N

        jLabel3.setText(resourceMap.getString("jLabel3.text")); // NOI18N
        jLabel3.setName("jLabel3"); // NOI18N

        numaviTextField.setName("numaviTextField"); // NOI18N

        diraviField.setName("diraviField"); // NOI18N

        distaviField.setName("distaviField"); // NOI18N

        telcontactLabel.setText(resourceMap.getString("telcontactLabel.text")); // NOI18N
        telcontactLabel.setName("telcontactLabel"); // NOI18N

        telcontactField.setName("telcontactField"); // NOI18N

        telcontact2Field.setName("telcontact2Field"); // NOI18N
        ...
        contactPanelLayout.setHorizontalGroup(
            ...
            .addGroup(contactPanelLayout.createSequentialGroup()
                .addGroup(contactPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(contactPanelLayout.createSequentialGroup()
                        .addComponent(telcontactField, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 10, Short.MAX_VALUE)
                        .addComponent(telcontact2Field, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(telcontactLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(contactPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(contactPanelLayout.createSequentialGroup()
                        .addComponent(distaviField, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(34, 34, 34)
                        .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(3, 3, 3)
                        .addComponent(numaviTextField, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(nombaviField, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(diraviField, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contactPanelLayout.createSequentialGroup()
                .addGroup(contactPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(contactPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(nombaviField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(diraviField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(contactPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(numaviTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(contactPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(distaviField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(contactPanelLayout.createSequentialGroup()
                        .addComponent(telcontactLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(contactPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(telcontactField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(telcontact2Field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(contactPanelLayout.createSequentialGroup()
                        .addComponent(nombcontacLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 0, 0);
        mainPanel.add(contactPanel, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        mainPanel.add(databankSection, gridBagConstraints);

        databankPanel.setMaximumSize(new java.awt.Dimension(540, 145));
        databankPanel.setMinimumSize(new java.awt.Dimension(265, 113));
        databankPanel.setName("databankPanel"); // NOI18N
        databankPanel.setPreferredSize(new java.awt.Dimension(265, 113));
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 0, 0);
        mainPanel.add(databankPanel, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        mainPanel.add(printPanel, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        mainPanel.add(left1Filler, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        mainPanel.add(right1Filler, gridBagConstraints);

        add(mainPanel, java.awt.BorderLayout.CENTER);
    }// </editor-fold>//GEN-END:initComponents
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private hidrocon.custom.field.HidroIntegerField colegiadoField;
    private hidrocon.custom.label.HidroLabel colegiadoLabel;
    private hidrocon.custom.field.HidroTextField contacField;
    private hidrocon.custom.label.HidroLabel contacLabel;
    private hidrocon.custom.panel.HidroPanel contactPanel;
    private hidrocon.custom.panel.HidroSectionPanel contactSection;
    private hidrocon.custom.field.HidroTextField contafField;
    private hidrocon.custom.label.HidroLabel contafLabel;
    private hidrocon.custom.panel.HidroPanel databankPanel;
    private hidrocon.custom.panel.HidroSectionPanel databankSection;
    private hidrocon.custom.label.HidroLabel datosfincaLabel;
    private hidrocon.custom.panel.HidroPanel detailsPanel;
    private hidrocon.custom.panel.HidroSectionPanel detailsSection;
    private hidrocon.custom.field.HidroTextField dirField;
    private hidrocon.custom.label.HidroLabel dirLabel;
    private hidrocon.custom.field.HidroTextField diraviField;
    private hidrocon.custom.field.HidroTextField distaviField;
    private hidrocon.custom.field.HidroTextField distritoField;
    private hidrocon.custom.label.HidroLabel distritoLabel;
    private hidrocon.custom.field.HidroTextField edificioField;
    ...
    private hidrocon.custom.field.HidroTextField inicialField;
    private hidrocon.custom.label.HidroLabel inicialLabel;
    ...
    private hidrocon.custom.field.HidroTextField nombaviField;
    private hidrocon.custom.field.HidroTextField nombcontacField;
    private hidrocon.custom.label.HidroLabel nombcontacLabel;
    private hidrocon.custom.field.HidroTextField numacvivField;
    private hidrocon.custom.label.HidroLabel numacvivLabel;
    private hidrocon.custom.field.HidroTextField numafvivField;
    private hidrocon.custom.label.HidroLabel numafvivLabel;
    private hidrocon.custom.field.HidroTextField numaviTextField;
    private hidrocon.custom.field.HidroIntegerField numlectanoField;
    private hidrocon.custom.label.HidroLabel numlectanoLabel;
    ...
    private hidrocon.custom.field.HidroTextField telcontact2Field;
    private hidrocon.custom.field.HidroTextField telcontactField;
    private hidrocon.custom.label.HidroLabel telcontactLabel;
