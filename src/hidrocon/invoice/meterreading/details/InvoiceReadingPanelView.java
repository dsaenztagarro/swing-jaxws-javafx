...
import hidrocon.core.pattern.observer.SwingFXWrapper;
...
public class InvoiceReadingPanelView extends HidroMainPanel {
    ...
    private InvoiceReadingFXController invoiceReadingFXController;
	...
	org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(hidrocon.HidroconApp.class).getContext().getResourceMap(HidroconView.class);
        ...
        invoiceReadingFXController = new InvoiceReadingFXController(invoiceReadingFXView);
    ...
    protected void notifyAppEvent2FX(final AppEvent appEvent) {
        Platform.runLater(new Runnable() { 
            @Override
            public void run() {
                invoiceReadingFXController.processAppEvent(appEvent); 
            }
        });        
    }
    ...
    public void addController(HidroController controller) {
        invoiceReadingFXController.addObserver(controller);
    }
